...
export const Header = ({ placeholder }) => {
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
      <div className='relative flex item-center h-10 cursor-pointer' onClick={() => router.push('/')}>
        <Image
          src={Logo}
          objectFit='contain'
          objectPosition='left'
      ...
      <div className='flex items-center justify-end text-gray-500 space-x-4'>
        <p className='hidden md:inline-flex cursor-pointer'>Became a host</p>
      ...
      {searchInput &&
        <div className='flex flex-col col-span-3 mx-auto'>
          ...
          <div className='flex'>
            <button className='flex-grow text-gray-600' onClick={resetInputs}>Cancel</button>
